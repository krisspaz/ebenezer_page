...
@NonNullApi
public class EbenezerMobileProjectDependency extends DelegatingProjectDependency {

    @Inject
    public EbenezerMobileProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
